...
<div class="flex h-screen">
    ...
    <li>
        <a href="kelola_praktikum.php" class="<?php echo ($activePage == 'praktikum') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
            <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 9.75h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5M5.25 6H18a2.25 2.25 0 012.25 2.25v3.75a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V8.25A2.25 2.25 0 015.25 6z" /></svg>
    ...
    <li>
        <a href="pengguna.php" class="<?php echo ($activePage == 'pengguna') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
            <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.67c.12-.318.232-.656.328-1.014a6.375 6.375 0 011.02-3.487m-11.54-2.921a6.375 6.375 0 00-1.32.949m11.54-2.921c.252-.412.422-.857.518-1.33a6.375 6.375 0 00-3.262-5.323m-7.018 5.323c-.346.434-.646.92-.872 1.439a6.375 6.375 0 00-1.125 3.28m1.125-3.28a6.375 6.375 0 011.32-.949m-1.32.949c-.283.44-.523.91-.704 1.405a6.375 6.375 0 00-1.042 3.428m1.042-3.428a6.375 6.375 0 01.704-1.405" /></svg>
